...
type MachineLifecycleStatus struct {
	...
	LastScanResult       ScanResult                       `protobuf:"varint,2,opt,name=last_scan_result,json=lastScanResult,proto3,enum=lcmi.api.machine_lifecycle.v1alpha1.ScanResult" json:"last_scan_result,omitempty"`
...
func (m *MachineLifecycleStatus) GetLastScanResult() ScanResult {
	if m != nil {
...
type ScanResponse struct {
	Status               *MachineLifecycleStatus `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	State                ScanState               `protobuf:"varint,2,opt,name=state,proto3,enum=lcmi.api.machine_lifecycle.v1alpha1.ScanState" json:"state,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func init() {
	proto.RegisterEnum("lcmi.api.machine_lifecycle.v1alpha1.ScanResult", ScanResult_name, ScanResult_value)
	proto.RegisterEnum("lcmi.api.machine_lifecycle.v1alpha1.ScanState", ScanState_name, ScanState_value)
...
var fileDescriptor_916165098a09e24c = []byte{
	...
	,
}
