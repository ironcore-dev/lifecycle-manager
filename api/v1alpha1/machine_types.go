...
// MachineSpec contains desired configuration of machine lifecycle.
...
// MachineStatus contains observed state of Machine object.
...
// +kubebuilder:printcolumn:name="Last Scan Time",type=string,JSONPath=`.status.lastScanTime`,description="Last scan timestamp"
// +kubebuilder:printcolumn:name="Last Scan Result",type=string,JSONPath=`.status.lastScanResult`,description="Last scan result"

// Machine is the schema for Machine API object.
type Machine struct {
...
// MachineList contains a list of Machine objects.
