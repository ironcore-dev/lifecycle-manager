...
func extractMachine(machine *lifecyclev1alpha1.Machine, fieldManager string, subresource string) (*MachineApplyConfiguration, error) {
	b := &MachineApplyConfiguration{}
	err := managedfields.ExtractInto(machine, internal.Parser().Type("com.github.ironcore-dev.lifecycle-manager.api.lifecycle.v1alpha1.Machine"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
