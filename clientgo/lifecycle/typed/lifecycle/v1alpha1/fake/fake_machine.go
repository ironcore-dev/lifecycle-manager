...
func (c *FakeMachines) Apply(ctx context.Context, machine *lifecyclev1alpha1.MachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Machine, err error) {
	if machine == nil {
...
func (c *FakeMachines) ApplyStatus(ctx context.Context, machine *lifecyclev1alpha1.MachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Machine, err error) {
	if machine == nil {
		return nil, fmt.Errorf("machine provided to Apply must not be nil")
	}
	data, err := json.Marshal(machine)
