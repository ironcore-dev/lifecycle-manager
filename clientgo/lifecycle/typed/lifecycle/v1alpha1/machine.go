...
type MachineInterface interface {
	...
	Apply(ctx context.Context, machine *lifecyclev1alpha1.MachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Machine, err error)
	ApplyStatus(ctx context.Context, machine *lifecyclev1alpha1.MachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Machine, err error)
	MachineExpansion
}
...
func newMachines(c *LifecycleV1alpha1Client, namespace string) *machines {
	return &machines{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *machines) Apply(ctx context.Context, machine *lifecyclev1alpha1.MachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Machine, err error) {
	if machine == nil {
...
func (c *machines) ApplyStatus(ctx context.Context, machine *lifecyclev1alpha1.MachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Machine, err error) {
	if machine == nil {
		return nil, fmt.Errorf("machine provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
